...
import { FIND_API_URL, ADD_STORE_TO_USER_URL, GET_ALL_PRODUCTS, UPDATE_STORE_URL, ADD_EVENT_TO_USER_URL} from './apiConfig';
...
function App() {
  ...
  return (
    <div className="App">
      <BrowserRouter>
        <Routes>
          <Route path="/" element={<Home user={user} food={foodNearMe} stores={storesNearMe} events={eventsNearMe} openSignUp={openSignUp} closeSignUp={closeSignUp} openLogIn={openLogIn} closeLogIn={closeLogIn} signedIn={signedIn} setSignedIn={setSignedIn} />} />
          <Route path="/discover" element={<Discover user={user} food={foodNearMe} stores={storesNearMe} events={eventsNearMe} openSignUp={openSignUp} closeSignUp={closeSignUp} openLogIn={openLogIn} closeLogIn={closeLogIn} signedIn={signedIn} setSignedIn={setSignedIn} />} />
          <Route path="/map" element={<Map user={user} food={foodNearMe} stores={storesNearMe} events={eventsNearMe} openSignUp={openSignUp} closeSignUp={closeSignUp} openLogIn={openLogIn} closeLogIn={closeLogIn} signedIn={signedIn} setSignedIn={setSignedIn} />} />
          {signedIn ?
            <>
